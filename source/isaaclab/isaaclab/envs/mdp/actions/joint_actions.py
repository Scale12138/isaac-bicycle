...
class JointAction(ActionTerm):
    ...
    def __init__(self, cfg: actions_cfg.JointActionCfg, env: ManagerBasedEnv) -> None:
        ...
        # rear wheel
        # self._joint_ids_rear, self._joint_names_rear = self._asset.find_joints(
        #     ["frame_wheel_joint"], preserve_order=self.cfg.preserve_order
        # )
        # self.constant_rear_vel = torch.full((self.num_envs, 1), -4.0, device=self.device)
...
class JointPositionAction(JointAction):
    ...
    def apply_actions(self):
        ...
        # print('constant_rear_vel: ', self.constant_rear_vel)
        # print('rear wheel: ', self._joint_ids_rear)
        # self._asset.set_joint_velocity_target(self.constant_rear_vel, joint_ids=self._joint_ids_rear)
